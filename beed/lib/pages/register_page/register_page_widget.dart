              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(32.0, 5.0, 32.0, 32.0),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                              ...
                              onPressed: () async {
                                if ((_model.textController1.text != null &&
                                  ...
                                  _model.apiResultj1t =
                                    ...
                                    surname: _model.textController3.text,
                                    mail: _model.textController4.text,
                                    phone: _model.textController5.text,
                                    password: _model.textController6.text,
                                    deviceToken: _model.fcmToken,
                                  );
                                  if ((_model.apiResultj1t?.succeeded ??
                                      true)) {
                                    context.pushNamed(
                                      'login_page',
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title:
                                              Text('Unsucceed Registiration'),
                                          content: Text(getJsonField(
                                            (_model.apiResultj1t?.jsonBody ??
                                                ''),
                                            r'''$.responseMessage''',
                                          ).toString()),
                                          actions: [
