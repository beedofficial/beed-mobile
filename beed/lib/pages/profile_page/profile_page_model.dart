...
class ProfilePageModel extends FlutterFlowModel<ProfilePageWidget> {
  ...
  bool isViewingAuctionHistory = true;
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController1(
    ...
    return controller
      ..addPageRequestListener(listViewGetProfileHistoryAuctionsPage1);
  }

  void listViewGetProfileHistoryAuctionsPage1(ApiPagingParams nextPageMarker) =>
      listViewApiCall1!(nextPageMarker)
          .then((listViewGetProfileHistoryAuctionsResponse) {
        final pageItems = (getJsonField(
                  listViewGetProfileHistoryAuctionsResponse.jsonBody,
        ...
        listViewPagingController1?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewGetProfileHistoryAuctionsResponse,
                )
              : null,
        );
      });
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController2(
    ...
    return controller
      ..addPageRequestListener(listViewGetProfileHistoryBidsPage2);
  }

  void listViewGetProfileHistoryBidsPage2(ApiPagingParams nextPageMarker) =>
      listViewApiCall2!(nextPageMarker)
          .then((listViewGetProfileHistoryBidsResponse) {
        final pageItems = (getJsonField(
                  listViewGetProfileHistoryBidsResponse.jsonBody,
        ...
        listViewPagingController2?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  nextPageNumber: nextPageMarker.nextPageNumber + 1,
                  numItems: newNumItems,
                  lastResponse: listViewGetProfileHistoryBidsResponse,
                )
              : null,
        );
      });
